...
export async function getAreas() {
  try {
    ...
    throw new Error(getErrorMessage(error) || "Failed to load areas");
  }
}

// Get meals by category
export async function getMealsByCategory(category: any) {
  try {
    ...
    throw new Error(getErrorMessage(error) || "Failed to load meals");
  }
}

// Get meals by area
export async function getMealsByArea(area : any) {
  try {
