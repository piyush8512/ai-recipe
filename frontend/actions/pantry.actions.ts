...
`;
    ...
    throw new Error(getErrorMessage(error, "Failed to scan image"));
  }
}
...
export async function saveToPantry(formData: FormData) {
  try {
    ...
    const ingredients = JSON.parse(ingredientsJson) as ScannedIngredient[];
    ...
    throw new Error(getErrorMessage(error, "Failed to save items"));
  }
}
...
export async function getPantryItems() {
  try {
    ...
    throw new Error(getErrorMessage(error, "Failed to load pantry"));
  }
}
...
export async function deletePantryItem(formData: FormData) {
  try {
    ...
    throw new Error(getErrorMessage(error, "Failed to delete item"));
  }
}
...
export async function updatePantryItem(formData: FormData) {
  try {
    ...
    if (
      ...
      throw new Error("Invalid pantry item update payload");
    }
